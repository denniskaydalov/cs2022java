...
public class DrawPanel extends JPanel {
    ...
    class MouseEventListener extends MouseAdapter {
        ...
        public void mousePressed( MouseEvent event ) {
            ...
            currentRectangle = new Rectangle( event.getX(), event.getX(), event.getY(), event.getY(), Color.RED, false );
        ...
        public void mouseReleased( MouseEvent event ) {
            ...
            //currentRectangle.setX2( event.getX()-currentRectangle.getX1() );
            //currentRectangle.setY2( event.getY()-currentRectangle.getY1() );
